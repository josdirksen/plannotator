...
function DocumentPreview({ artifact }: { readonly artifact: PRArtifact }): React.JSX.Element {
    ...
    return (
      <div className="absolute inset-0 overflow-hidden bg-white">
        <iframe
          ...
          srcDoc={injectArtifactBaseUrl(state.content, artifact.url)}
          sandbox=""
          tabIndex={-1}
          aria-hidden="true"
  ...
  return (
    <div className="absolute inset-0 overflow-hidden bg-background text-foreground">
      <div className="pointer-events-none h-[200%] w-[200%] origin-top-left scale-50 overflow-hidden p-7">
...
function ArtifactPreview({ artifact }: { readonly artifact: PRArtifact }): React.JSX.Element {
